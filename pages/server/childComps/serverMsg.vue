<template>
	<view class="setMsg">
		<view :style="{background:background[1]}" class="circle">
			<vus-sphere-progress :anim="true" :percent="percent" :color="[background[3],background[2],background[4]]"
				font-size="32rpx" :width="100"></vus-sphere-progress>
		</view>
	</view>
</template>
